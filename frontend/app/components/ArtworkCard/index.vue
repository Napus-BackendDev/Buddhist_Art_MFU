    ...
    <div class="relative  rounded-xl overflow-hidden bg-white shadow-sm hover:shadow-lg transition-shadow duration-300">
        <div class="relative">
            ...
            <div class="absolute top-3 right-3 flex gap-2">
                <button class="bg-white/80 backdrop-blur px-2 py-2 rounded-md shadow">♡</button>
                <button class="bg-white/80 backdrop-blur px-2 py-2 rounded-md shadow">◼︎</button>
            </div>
        ...
        <div class="p-5">
            ...
            <button class="mt-5 w-full px-4 py-3 rounded-lg flex items-center justify-center gap-2"
