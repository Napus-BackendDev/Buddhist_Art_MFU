<template>
    <div class="flex flex-col min-h-screen justify-center items-center">
        <UForm
:schema="schema" :state="state" class="flex flex-col justify-center items-center gap-8 pt-12 pb-16 px-30 rounded-2xl bg-white  shadow-md"
            @submit="onSubmit">
            ...
            <UFormField label="Username" class="w-full" :ui="{ label: 'text-black' }">
                <UInput
v-model="state.studentId" icon="mdi:account-outline" variant="subtle" label="Username" :ui="{ base: 'text-black bg-white' }" 
                    placeholder="StudentID..." size="md" color="error" class="w-full" />
            </UFormField>
            <UFormField label="Password" class="w-full" :ui="{ label: 'text-black' }">
                <UInput
v-model="state.password" icon="mdi:lock-outline" variant="subtle" type="password"
            ...
            <UButton
type="submit" color="error" variant="solid" size="lg"
